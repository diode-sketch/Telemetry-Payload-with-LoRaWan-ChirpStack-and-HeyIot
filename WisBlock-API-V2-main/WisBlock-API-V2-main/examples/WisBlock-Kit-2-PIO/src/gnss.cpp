...
bool init_gnss(void)
{
	...
	delay(2000);
// Start serial to send UBX config
Serial1.begin(9600);
delay(500);

// Set airborne <4g dynamic model (unlocks >18km altitude)
uint8_t ubx_airborne[] = {
...
Serial1.write(ubx_airborne, sizeof(ubx_airborne));
delay(500);
Serial1.end();
...
// Re-send airborne mode after power cycle
uint8_t ubx_airborne[] = {
    0xB5, 0x62, 0x06, 0x24, 0x24, 0x00,
    0xFF, 0xFF, 0x06, 0x03, 0x00, 0x00,
    0x00, 0x00, 0x10, 0x27, 0x00, 0x00,
